...
ActiveRecord::Schema[7.0].define(version: 2024_02_22_122429) do
  ...
  create_table "refuelling_settings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["fuel_station_id"], name: "index_refuelling_settings_on_fuel_station_id"
    t.index ["fuel_type_id"], name: "index_refuelling_settings_on_fuel_type_id"
    t.index ["vehicle_id"], name: "index_refuelling_settings_on_vehicle_id"
  end
  ...
  add_foreign_key "refuelling_settings", "fuel_stations"
  add_foreign_key "refuelling_settings", "fuel_types"
  add_foreign_key "refuelling_settings", "vehicles"
